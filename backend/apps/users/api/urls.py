...
from users.api.views import (
    ActivateUser, BlacklistToken, ChangeUserPassword,
    CreateUser, DeleteUser, GetCurrentUser, ResetUserPassword,
    SendEmailPasswordReset, SendEmailVerification, 
    SendEmailDeleteUser, UploadUserAvatar, ChangeUserDetails
)
