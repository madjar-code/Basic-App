...
class TestSerializers(TestCase):
    def setUp(self) -> None:
        ...
        self.user_serializer = UserSerializer(data={
        ...
        self.user_password_serializer = UserPasswordSerializer(data={
            'password': 'strongpassword',
            'new_password': 'evenstrongpassword',
        })
        ...
        self.user_details_serializer = UserDetailsSerializer(data={
            'username': 'testusername',
            'email': 'testemail@example.com',
            'first_name': 'Test',
            'last_name': 'Tested',
    ...
    def test_user_serializer(self):
        ...
        User serializer
        """
        serializer: UserSerializer = self.user_serializer
